...
<body>
    ...
    Dropzone.options.imageUpload = {
        ...
        addRemoveLinks: true, // Menambahkan tombol hapus pada thumbnail
        createImageThumbnails: true, // Membuat thumbnail untuk pratinjau gambar
        autoProcessQueue: false, // Jangan langsung mengunggah, tunggu tombol diklik
        init: function () {
            var myDropzone = this;
            ...
            this.on('sending', function(file, xhr, formData) {
                // Tambahkan semua input form ke data yang akan dikirim
