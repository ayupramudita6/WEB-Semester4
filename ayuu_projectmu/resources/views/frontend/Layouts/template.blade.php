...
<head>
  ...
  <!-- Google Fonts -->
  <link href="https://fonts.googleapis.com/css2?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Dosis:300,400,500,600,700,700i|Lato:300,300i

  <!-- Vendor CSS Files -->
  <link href="{{ asset('frontend/assets/vendor/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">
  <link href="{{ asset('frontend/assets/vendor/iconfont.min.css')}}" rel="stylesheet">
  <link href="{{ asset('frontend/assets/vendor/boxicon/css/boxicons.min.css')}}" rel="stylesheet">
  <link href="{{ asset('frontend/assets/vendor/venobox.css')}}" rel="stylesheet">
